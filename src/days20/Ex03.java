...
/**
 * @author Osj  
 * @date   2025. 9. 12. 오전 11:04:53
 * @subject 어떤 객체로부터 클래스 정보를 얻어노는 3가지 방법
 * @content 			Class 타입
 */
public class Ex03 {
...
/*		Class classInfo= c1.getClass();
	...
	*/	
		...
		// 객체 생성
		//Type mismatch: cannot convert from Object to Card
...
//final 클래스 : subclass 자식 클래스를 가질 수 없는 최종 클래스
final class Card{
